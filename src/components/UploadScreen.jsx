// UploadScreen.jsx — The first screen users see
// Features: drag-and-drop upload, animated background, clear instructions
// When a PDF is dropped or selected, it calls onFileSelect(file)

import { useState, useRef } from "react";

export default function UploadScreen({ onFileSelect, isLoading, loadingMsg }) {
  // isDragging: true when user drags a file over the drop zone
...
// ── Styles ─────────────────────────────────────────────────────────────────────
// All styles as JS objects (no CSS files needed — self-contained component)
const styles = {
  container: {
    minHeight: "100vh",
    background: "#070b14",
